...
class SprFaculty(db.Model):
    ...
    id_branch = db.Column(db.Integer, db.ForeignKey('spr_branch.id_branch'), nullable=False)
...
class AUP(db.Model):
    ...
    id_op = db.Column(db.Integer, db.ForeignKey('tbl_op.id_op', ondelete='CASCADE'))
...
class DurationEducation(db.Model):
    ...
    id_degree = db.Column(db.Integer, db.ForeignKey('spr_degree_education.id_degree'), nullable=False)
    id_form = db.Column(db.Integer, db.ForeignKey('spr_form_education.id_form'), nullable=False)
    years = db.Column(db.Integer, nullable=False)
    months = db.Column(db.Integer, nullable=True)
    id_spec = db.Column(db.Integer, db.ForeignKey('spr_name_op.id_spec'), nullable=False)
...
class OP(db.Model):
    ...
    id_duration = db.Column(db.Integer, db.ForeignKey('tbl_duration_edu.id_duration'), nullable=False)
    id_faculty = db.Column(db.Integer, db.ForeignKey('spr_faculty.id_faculty'), nullable=False)
...
class Workload(db.Model):
    ...
    id_aup = db.Column(db.Integer, db.ForeignKey('tbl_aup.id_aup', ondelete='CASCADE'), nullable=False)
    ...
    id_module = db.Column(db.Integer, db.ForeignKey('tbl_module.id_module'), nullable=False)
