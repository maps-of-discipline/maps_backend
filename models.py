...
class D_Chast(db.Model):
    __tablename__ = 'd_chast'
    id = db.Column(db.Integer, primary_key=True)
    title = db.Column(db.String(255), nullable=False)
...
class AupInfo(db.Model):
    ...
    name_faculty = db.Column(db.String(50), nullable=False)
...
class AupData(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    aup_num = db.Column(db.Integer, nullable=False)
    ...
    period_control_id = db.Column(db.Integer, nullable=False)
    type_control_id = db.Column(db.Integer, nullable=False)
