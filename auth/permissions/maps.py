...
class CanUploadPlan(CanEditOwnFaculty): ...

class CanAddModule(CanEditOwnFaculty): ...

class CanChangeModule(CanEditOwnFaculty): ...

class CanAddGroup(CanEditOwnFaculty): ...

class CanDeleteGroup(CanEditOwnFaculty): ...

class CanUpdateGroup(CanEditOwnFaculty): ...

class CanSaveWeeks(CanEditOwnFaculty): ...

class CanSaveReports(CanEditOwnFaculty): ...
